...
If my (TheFox#5812's) work is used in a project that is not ShinigamiGDPS, I have the full right to request my work, being the translation, removed from the project. If not done, i have full permission to fill a DMCA claim to the domain of the project.
...
TL;DR if you use this outside ShinigamiGDPS i can delet your site kthxbye
